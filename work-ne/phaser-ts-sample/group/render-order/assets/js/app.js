...
(function (FeatureSample) {
    var MainGame = /** @class */ (function (_super) {
        ...
        function MainGame(config) {
            ...
            _this.state.add('ObjectSample', FeatureSample.GroupRenderOrderSample);
...
(function (FeatureSample) {
    var GroupAlignSample = /** @class */ (function (_super) {
        ...
        GroupAlignSample.prototype.create = function () {
            ...
            this.group.callAll('scale.set', 'scale', 0.5);
            this.add.sprite(0, 0, this.game.create.grid('grid', 120 * 5, 120 * 4, 120, 120, 'rgba(0, 250, 0, 1)'));
            this.makeButton('center', 420, 40, function () { _this.group.align(5, 3, 120, 120, Phaser.CENTER); });
            this.makeButton('top-right', 420, 80, function () { _this.group.align(5, 3, 120, 120, Phaser.TOP_RIGHT); });
            this.makeButton('top-left', 420, 120, function () { _this.group.align(5, 3, 120, 120, Phaser.TOP_LEFT); });
            this.makeButton('top', 420, 160, function () { _this.group.align(5, 3, 120, 120, Phaser.TOP_CENTER); });
            this.makeButton('bottom-left', 420, 200, function () { _this.group.align(5, 3, 120, 120, Phaser.BOTTOM_LEFT); });
            this.makeButton('bottom-right', 420, 240, function () { _this.group.align(5, 3, 120, 120, Phaser.BOTTOM_RIGHT); });
            this.makeButton('bottom', 420, 280, function () { _this.group.align(5, 3, 120, 120, Phaser.BOTTOM_CENTER); });
            this.makeButton('left', 420, 320, function () { _this.group.align(5, 3, 120, 120, Phaser.LEFT); });
            this.makeButton('right', 420, 360, function () { _this.group.align(5, 3, 120, 120, Phaser.RIGHT); });
        };
        // 테스트를 위한 버튼 생성
...
(function (FeatureSample) {
    var GroupRenderOrderSample = /** @class */ (function (_super) {
        ...
        GroupRenderOrderSample.prototype.create = function () {
            this.group = this.add.group();
            for (var i = 0; i < 11; i++) {
                this.group.create(200, (i * 32) + Math.random(), 'trees', 0);
            }
            this.shuffle();
            this.makeButton('sort - y ascending', 420, 100, this.sort_ascending);
            this.makeButton('sort - y descending', 420, 140, this.sort_descending);
            this.makeButton('shuffle', 420, 180, this.shuffle);
            this.makeButton('reverse', 420, 220, this.reverse);
        };
