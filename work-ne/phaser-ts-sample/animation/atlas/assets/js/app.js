...
(function (FeatureSample) {
    var MainGame = /** @class */ (function (_super) {
        ...
        function MainGame(config) {
            ...
            //State 추가
            _this.state.add('ObjectSample', FeatureSample.SpriteAnimationSample);
...
(function (FeatureSample) {
    var SpriteAnchorSample = /** @class */ (function (_super) {
        ...
        SpriteAnchorSample.prototype.create = function () {
            ...
            this.makeButton('anchor (0, 0)', 800, 100, function () { _this.sprite.anchor.x = _this.sprite.anchor.y = 0; });
            this.makeButton('anchor (0.5, 0.5)', 800, 140, function () { _this.sprite.anchor.x = _this.sprite.anchor.y = 0.5; });
            this.makeButton('anchor (1, 1)', 800, 180, function () { _this.sprite.anchor.x = _this.sprite.anchor.y = 1; });
            this.makeButton('anchor (0, 1)', 800, 220, function () { _this.sprite.anchor.x = 0; _this.sprite.anchor.y = 1; });
            this.makeButton('anchor (0, 0.5)', 800, 260, function () { _this.sprite.anchor.x = 0; _this.sprite.anchor.y = 0.5; });
            this.makeButton('anchor (1, 0)', 800, 300, function () { _this.sprite.anchor.x = 1; _this.sprite.anchor.y = 0; });
        };
...
(function (FeatureSample) {
    ...
    var BitmapTextSample = /** @class */ (function (_super) {
        ...
        BitmapTextSample.prototype.clear = function () {
        };
        // 테스트를 위한 버튼 생성
...
(function (FeatureSample) {
    var TextEffectSample = /** @class */ (function (_super) {
        ...
        TextEffectSample.prototype.create = function () {
            ...
            // this.text.addColor('#ff00ff', 6);
            // this.text.addColor('#ffffff', 9);
            ...
            this.makeButton('color', 800, 100, function () {
                _this.text.fill = Math.random() * 0xffffff;
            });
            // Shadow
        ...
        TextEffectSample.prototype.clear = function () {
        };
        // 테스트를 위한 버튼 생성
